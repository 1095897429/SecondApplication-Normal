...
//                    * (mWheelSize / 2 + 1), mHoloPaint);
            if(mStyle.holoLineAllWidth){
                canvas.drawLine(0, mItemH * (mWheelSize / 2), mWidth, mItemH
                    * (mWheelSize / 2), mHoloPaint);
            canvas.drawLine(0, mItemH * (mWheelSize / 2 + 1), mWidth, mItemH
                    * (mWheelSize / 2 + 1), mHoloPaint);
            }else{
                canvas.drawLine(mWidth/2-mStyle.holoLineWidth/2, mItemH * (mWheelSize / 2), mWidth/2+mStyle.holoLineWidth/2, mItemH
                        * (mWheelSize / 2), mHoloPaint);
                canvas.drawLine(mWidth/2-mStyle.holoLineWidth/2, mItemH * (mWheelSize / 2 + 1), mWidth/2+mStyle.holoLineWidth/2, mItemH
                        * (mWheelSize / 2 + 1), mHoloPaint);
            }
